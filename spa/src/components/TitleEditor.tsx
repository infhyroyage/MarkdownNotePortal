...
import type { TitleEditorProps } from "../types/props";

/**
 * メモのタイトルを表示・編集するコンポーネント
 * @param {TitleEditorProps} props タイトルエディターコンポーネントのProps
 * @returns {JSX.Element} タイトルを表示・編集するコンポーネント
 */
export default function TitleEditor(props: TitleEditorProps): JSX.Element {
  const { hasSelectedMemo, onUpdateTitle, title } = props;
